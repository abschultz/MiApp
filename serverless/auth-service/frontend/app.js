...
const AUTH0_CLIENT_ID = 'A-fquBjOMtFufUM6ME9QBatyjn1ap6mk';
const AUTH0_DOMAIN = 'mi-app.auth0.com';
// const AUTH0_CALLBACK_URL = window.location.href; // eslint-disable-line
const PUBLIC_ENDPOINT = 'https://5fqv0tr44i.execute-api.us-east-1.amazonaws.com/dev/api/public';
const PRIVATE_ENDPOINT = 'https://5fqv0tr44i.execute-api.us-east-1.amazonaws.com/dev/api/private';
